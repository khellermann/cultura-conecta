...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Casa da Cultura de Siqueira Campos" },
      {
        name: "description",
        content:
          "Sistema de controle de visitantes da Casa da Cultura de Siqueira Campos/PR.",
      },
      { property: "og:title", content: "Casa da Cultura de Siqueira Campos" },
      { name: "twitter:title", content: "Casa da Cultura de Siqueira Campos" },
